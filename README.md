...
This project is a [_fastlane_](https://github.com/fastlane/fastlane) plugin. To get started with `fastlane-plugin-sonar_test_report`, add it to your project by running:

```bash
fastlane add_plugin sonar_test_report
```

## About sonar_test_report
